...
export const OCEAN_PASTEL_BRANDING: BrandingConfig = {
...
export const OCEAN_TEXT_STYLES: TextStyle[] = [
  {
    element: 'title',
    fontSize: 46,
    fontFamily: 'Poppins',
...
export const OCEAN_SLIDE_TEMPLATES: SlideTemplate[] = [
  {
    type: 'title',
...
export const OCEAN_PASTEL_TEMPLATE: PresentationTemplate = {
  id: 'ocean-pastel',
